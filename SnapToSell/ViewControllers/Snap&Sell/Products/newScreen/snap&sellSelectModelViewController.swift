...
class snap_sellSelectModelViewController: UIViewController, UICollectionViewDelegate , UICollectionViewDataSource ,UICollectionViewDelegateFlowLayout{
    ...
    func callApi(id : String)  {
        ...
        NetworkManager.SharedInstance.getBrnad(Id: id, success: { (res) in
            
            SVProgressHUD.dismiss()
            guard let arr = res.Products else{
                return
            }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.brandName.text = self.brandArray[indexPath.row].BRAND_NAME
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
         ...
         let main = self.storyboard?.instantiateViewController(withIdentifier: "SelectSeriesViewController") as! SelectSeriesViewController
       
        main.id = self.brandArray[indexPath.row].BRAND_DT_ID!
        Constants.brand_name = self.brandArray[indexPath.row].BRAND_DT_ID!
