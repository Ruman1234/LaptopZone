//
//  SelectSeriesViewController.swift
//  SnapToSell
//
...
class SelectSeriesViewController: UIViewController, UICollectionViewDelegate , UICollectionViewDataSource ,UICollectionViewDelegateFlowLayout{
    ...
    func callApi(id : String)  {
        ...
        NetworkManager.SharedInstance.getSeries(Id: id, success: { (res) in
            
            SVProgressHUD.dismiss()
            guard let arr = res.series else{
                return
            }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.brandName.text = self.brandArray[indexPath.row].SERIES_NAME
//        cell.imageView.sd_setImage(with: URL(string: self.brandArray[indexPath.row].BRAND_URL_FULL!), placeholderImage: UIImage(named: "placeholder.png"))
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
         ...
         let main = self.storyboard?.instantiateViewController(withIdentifier: "SelectModelViewController") as! SelectModelViewController
       
        main.id = self.brandArray[indexPath.row].SERIES_DT_ID!
        Constants.series_name = self.brandArray[indexPath.row].SERIES_DT_ID!
