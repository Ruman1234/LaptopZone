...
//        secondVC.data?.delegate = firstVC
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.backButtonDidPress), name: Notification.Name("backStepShippment"), object: nil)
        
        NotificationCenter.default.addObserver(self, selector: #selector(self.changeBtn), name: Notification.Name("changeBtnshipment"), object: nil)
